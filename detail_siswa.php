                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <h4 class="m-y-0">Edit Pegawai</h4>
                          <hr>
                          <form id="inputmasks" class="form-horizontal"  method="post" action="system/proses_ubah_siswa.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-control-1">Kelas</label>
                                <div class="col-sm-9">
                                    <input id="form-control-1" class="form-control" type="text" name="kelas" value="<?php echo $jabatan ?>" >
                                </div>
                            </div>
                            <div class="form-group">
